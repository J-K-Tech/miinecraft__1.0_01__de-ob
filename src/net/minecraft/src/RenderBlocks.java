...
public class RenderBlocks {
	...
	public boolean renderStandardBlockWithColorMultiplier(Block block, int var2, int var3, int var4, float red_input, float green_input, float blue_input) {
		Tessellator tessellator_instance = Tessellator.instance;
		boolean var9 = false;
		float bottom_light = 0.5F;
		float white = 1.0F;
		float Z_light = 0.8F;
		float X_light = 0.6F;
		float var14 = white * red_input;
		float var15 = white * green_input;
		float var16 = white * blue_input; // lol lets see what it does
		...
		// red
		float bottom_red = bottom_light * red_input;
		float Z_red = Z_light * red_input;
		float X_red = X_light * red_input;

		// green
		float bottom_green = bottom_light * green_input;
		float Z_green = Z_light * green_input;
		float X_green = X_light * green_input;
		// blue
		float bottom_blue = bottom_light * blue_input;
		float Z_blue = Z_light * blue_input;
		float X_blue = X_light * blue_input;

		float var26 = block.getBlockBrightness(this.blockAccess, var2, var3, var4);
		float var27;
		if(this.renderAllFaces || block.shouldSideBeRendered(this.blockAccess, var2, var3 - 1, var4, 0)) {
			var27 = block.getBlockBrightness(this.blockAccess, var2, var3 - 1, var4);
			tessellator_instance.setColorOpaque_F(bottom_red * var27, bottom_green * var27, bottom_blue * var27);
			this.renderBottomFace(block, (double)var2, (double)var3, (double)var4, block.getBlockTexture(this.blockAccess, var2, var3, var4, 0));
			var9 = true;
		}

		if(this.renderAllFaces || block.shouldSideBeRendered(this.blockAccess, var2, var3 + 1, var4, 1)) {
			var27 = block.getBlockBrightness(this.blockAccess, var2, var3 + 1, var4);
			if(block.maxY != 1.0D && !block.blockMaterial.getIsLiquid()) {
				var27 = var26;
			}

			tessellator_instance.setColorOpaque_F(var14 * var27, var15 * var27, var16 * var27);
			this.renderTopFace(block, (double)var2, (double)var3, (double)var4, block.getBlockTexture(this.blockAccess, var2, var3, var4, 1));
			var9 = true;
		}

		if(this.renderAllFaces || block.shouldSideBeRendered(this.blockAccess, var2, var3, var4 - 1, 2)) {
			var27 = block.getBlockBrightness(this.blockAccess, var2, var3, var4 - 1);
			if(block.minZ > 0.0D) {
				var27 = var26;
			}

			tessellator_instance.setColorOpaque_F(Z_red * var27, Z_green * var27, Z_blue * var27);
			this.renderEastFace(block, (double)var2, (double)var3, (double)var4, block.getBlockTexture(this.blockAccess, var2, var3, var4, 2));
			var9 = true;
		}

		if(this.renderAllFaces || block.shouldSideBeRendered(this.blockAccess, var2, var3, var4 + 1, 3)) {
			var27 = block.getBlockBrightness(this.blockAccess, var2, var3, var4 + 1);
			if(block.maxZ < 1.0D) {
				var27 = var26;
			}
			...
			tessellator_instance.setColorOpaque_F(Z_red * var27, Z_green * var27, Z_blue * var27);
			this.renderWestFace(block, (double)var2, (double)var3, (double)var4, block.getBlockTexture(this.blockAccess, var2, var3, var4, 3));
			var9 = true;
		}

		if(this.renderAllFaces || block.shouldSideBeRendered(this.blockAccess, var2 - 1, var3, var4, 4)) {
			var27 = block.getBlockBrightness(this.blockAccess, var2 - 1, var3, var4);
			if(block.minX > 0.0D) {
				var27 = var26;
			}

			tessellator_instance.setColorOpaque_F(X_red * var27, X_green * var27, X_blue * var27);
			this.renderNorthFace(block, (double)var2, (double)var3, (double)var4, block.getBlockTexture(this.blockAccess, var2, var3, var4, 4));
			var9 = true;
		}

		if(this.renderAllFaces || block.shouldSideBeRendered(this.blockAccess, var2 + 1, var3, var4, 5)) {
			var27 = block.getBlockBrightness(this.blockAccess, var2 + 1, var3, var4);
			if(block.maxX < 1.0D) {
				var27 = var26;
			}
			...
			tessellator_instance.setColorOpaque_F(X_red * var27, X_green * var27, X_blue * var27);
			this.renderSouthFace(block, (double)var2, (double)var3, (double)var4, block.getBlockTexture(this.blockAccess, var2, var3, var4, 5));
			var9 = true;
		}
